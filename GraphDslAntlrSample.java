...
public class GraphDslAntlrSample {
    public static void main(String[] args) throws IOException {
      ...
      InputStream is = ClassLoader.getSystemResourceAsStream("yeet.gr");
      ...
      parser.addParseListener(new GraphMyBaseListener(g));
...
class GraphMyBaseListener extends GraphBaseListener {

  Graph g;

  public GraphMyBaseListener(Graph g) {
      this.g = g;
  }
